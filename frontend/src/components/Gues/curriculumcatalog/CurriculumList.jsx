      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {curricula.map(curriculum => (
            <a href={`/curricula2/${curriculum.id}`} className="text-blue-500 hover:underline">
            <div key={curriculum.id} className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <a href={`/curricula2/${curriculum.id}`} className="text-blue-500 hover:underline">View Details</a>
            </div>
            </a>
          ))}
        </div>
